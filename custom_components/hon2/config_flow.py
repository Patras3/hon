...
from .hon2 import Hon2Connection
...
class Hon2FlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        # Test connection
        hon2 = Hon2Connection(None, None, self._email, self._password)
        if( await hon2.async_authorize() == False ):
            errors = {}
            errors["base"] = "auth_error"
            await hon2.async_close()
