...
class Hon2ParameterFixed(Hon2Parameter):
    def __init__(self, key, attributes):
...
class Hon2ParameterRange(Hon2Parameter):
    def __init__(self, key, attributes):
        super().__init__(key, attributes)
        try:
...
class Hon2ParameterEnum(Hon2Parameter):
    def __init__(self, key, attributes):
        super().__init__(key, attributes)
...
class Hon2ParameterProgram(Hon2ParameterEnum):
